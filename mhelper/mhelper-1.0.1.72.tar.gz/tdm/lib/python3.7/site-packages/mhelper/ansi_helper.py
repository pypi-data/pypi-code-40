"""
Ansi defines variables for ANSI colour escape sequences (KRGYBMCW...), and
font-formatting (bold, italic, dim, underline, blink, reset, ...), as well as
functions for generating 24-bit colour escape sequences.
Both short and long aliases are provided.
"""
